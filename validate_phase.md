...
- For an actual example [see this validate file:](https://github.com/travism26/claude_code_agent_templates/blob/main/example_projects/role_matcher_typescript_webapp/.claude/commands/validate.md)
